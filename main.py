    ...
    def new_tile(self, *args):
        ...
        if not empty_cells:
            ...
            popup = Popup(title='Game over',
                          content=Label(text='tentative: no cell'),
        ...
        if len(empty_cells) == 1 and self.is_deadlocked():
            ...
            popup = Popup(title='Game over',
                          content=Label(text='borard is deadlock'),
                          size_hint=(None, None), size=(400, 400))
            popup.open()
        ...
        for board_x, board_y in all_cells(dir_x > 0, dir_y > 0):
            ...
            if self.can_combine(x + dir_x, y + dir_y, tile.number):
                ...
                if (tile.number == 2048):
                    ...
                    popup = Popup(title='Winner is here!!',
                                  content=Label(text='highest tile value is 2048!!'),
                                  size_hint=(None, None), size=(400, 400))
                    popup.open()
